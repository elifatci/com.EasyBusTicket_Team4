...
public class US28_TC04 extends TestBaseRapor {
    @Test
    public void test01() {
        //1.Launch Browser
        //2.Navigate to url "https://www.qa.easybusticket.com/admin"homepage.
        extentTest=extentReports.createTest("Smoke test","On the Closed Requests page, which can be found on the left menu of the dashboard page, the Admin should be able to view all closed requests. I should also be able to access the details of a request through the action buttons such as Close, Reply, and Delete.");
        ...
        extentTest.pass("User can click on the \"Closed Requests\" link.");
       ...
       String actualUrl = Driver.getDriver().getCurrentUrl();
        ...
        extentTest.pass("User can verify that Closed Requests are visible.");
